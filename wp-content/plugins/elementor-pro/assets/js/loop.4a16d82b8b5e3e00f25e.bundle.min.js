        ...
        2098: (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                let {
                    element: t,
                    id: n,
                    title: a = o("Template", "elementor-pro")
                } = e, d = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l, m = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, c = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
                if (l === d) {
                    ...
                    if (function isCurrentlyEditing(e) {
                            ...
                            return !!e.querySelector(`:scope > .${s}`)
                        }(t)) return
                }
                const u = function createHandleElement(e, t) {
                    let {
                        title: n,
                        onClick: i
                    } = e, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
                    const d = ["header", "footer"].includes(a ? .dataset.elementorType) ? "%s" : o("Edit %s", "elementor-pro"),
                        m = createElement({
                            tag: "div",
                            classNames: [`${s}__inner`],
                            children: [createElement({
                                tag: "i",
                                classNames: [getHandleIcon(t)]
                            }), createElement({
                                tag: "div",
                                classNames: [`${l===t?s:r}__title`],
                                children: [document.createTextNode(l === t ? d.replace("%s", n) : o("Save %s", "elementor-pro").replace("%s", n))]
                            })]
                        }),
                        c = [s];
                    l !== t && c.push(r);
                    ...
                    return u.addEventListener("click", i), u
                }({
                    title: a,
                    onClick: () => async function onDocumentClick(e, t) {
                        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                            o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
                        l === t ? (window.top.$e.internal("panel/state-loading"), await window.top.$e.run("editor/documents/switch", {
                            id: parseInt(e),
                            onClose: n,
                            selector: o
                ...
                t.prepend(u), l === d && (t.dataset.editableElementorDocument = n)
            };
            const s = "elementor-document-handle",
                i = "elementor-edit-mode",
                l = t.EDIT_CONTEXT = "edit",
                r = "elementor-document-save-back-handle",
                a = t.SAVE_CONTEXT = "save";
            ...
            function createElement(e) {
                ...
                return s.classList.add(...n), o.forEach((e => s.appendChild(e))), s
            }
        },
        2813: (e, t, n) => {
            var o = n(2470).__,
            ...
            var i = s(n(2195)),
                l = function _interopRequireWildcard(e, t) {
            ...
            class Loop extends i.default {
                ...
                attachEditDocumentHandle() {
                    ...
                    const t = this.getElementSettings(),
                        ...
                        s = t ? .edit_handle_selector + ('[data-elementor-type="loop-item"]' === t ? .edit_handle_selector ? `.elementor-${e}` : ""),
                        i = this.$element.find(s).first()[0];
                    i && (this.isFirstEdit() ? this.$element.find(".elementor-swiper-button").remove() : (0, l.default)({
                        element: i,
                        title: o("Template", "elementor-pro"),
                        id: e
                    }, l.EDIT_CONTEXT, (() => this.onInPlaceEditTemplate()), `${n} .elementor-${e}`))
                }
                isFirstEdit() {
                ...
                onElementChange(e) {
                    "_skin" === e && elementorPro.modules.loopBuilder.onApplySkinChange(), i.default.prototype.onElementChange.apply(this)
                }
                bindEvents() {
                    super.bindEvents(), elementorFrontend.elements.$window.on("elementor-pro/loop-builder/after-insert-posts", this.reInitMasonry.bind(this))
                }
                reInitMasonry() {
                    const e = this.getSettings("selectors");
                    this.elements.$posts = jQuery(`.elementor-element-${this.getID()} ${e.post}`), super.runMasonry()
                }
                unbindEvents() {
                    super.unbindEvents(), elementorFrontend.elements.$window.off("elementor-pro/loop-builder/after-insert-posts", this.reInitMasonry.bind(this))
                }
                onInit() {
                ...
                fitImage(e) {
                    ...
                    if (o) {
                        var s = n.outerHeight() / n.outerWidth(),
                            i = o.naturalHeight / o.naturalWidth;
                        n.toggleClass(t.classes.fitHeight, i < s)
                    }
                },
                fitImages() {
                    var e = jQuery,
                        ...
                        o = this.getSettings();
                    t.isMasonryEnabled() ? this.elements.$postsContainer.removeClass(o.classes.hasItemRatio) : (this.elements.$postsContainer.toggleClass(o.classes.hasItemRatio, !!n.match(/\d/)), this.elements.$posts.each((function() {
                        var n = e(this),
                            s = n.find(o.selectors.postThumbnailImage);
                        t.fitImage(n), s.on("load", (function() {
                            t.fitImage(n)
                        }))
                    })))
                },
