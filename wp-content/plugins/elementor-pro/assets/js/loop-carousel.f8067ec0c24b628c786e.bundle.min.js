            ...
            class LoopCarousel extends elementorModules.frontend.handlers.CarouselBase {
                ...
                getSwiperSettings() {
                    const e = super.getSwiperSettings(),
                        ...
                        r = elementorFrontend.config.is_rtl,
                        s = `.elementor-element-${this.getID()}`;
                    return "yes" === t.arrows && (e.navigation = {
                        prevEl: r ? `${s} .elementor-swiper-button-next` : `${s} .elementor-swiper-button-prev`,
                        nextEl: r ? `${s} .elementor-swiper-button-prev` : `${s} .elementor-swiper-button-next`
                    }), e.on.beforeInit = () => {
                ...
                handleElementHandlers() {
                    ...
                    (0, l.default)(e), this.ranElementHandlers = !0
                }
                a11ySetSlidesAriaLabels() {
                    const e = Array.from(this.elements.$slides);
                    e.forEach(((t, r) => {
                        t.setAttribute("aria-label", `${parseInt(r+1)} ${s("of","elementor-pro")} ${e.length}`)
                    }))
                }
            }
